...
async function api(url,opt={}){
 opt.headers={...(opt.headers||{}),"Content-Type":"application/json",...(S.token?{Authorization:"Bearer "+S.token}:{})};
...
async function publicHome(){
 try{
  ...
  $("#app").innerHTML=`<header class="topbar"><div class="container" style="display:flex;width:100%;align-items:center"><div class="brand"><span class="brand-mark">♛</span><div><div class="brand-title">GOOD MOBILE</div><div class="brand-sub">PANEL MANAGEMENT</div></div></div><nav class="topnav"><a class="active" href="#home">⌂ &nbsp;Главная</a><a href="#home">▣ &nbsp;Новости</a><a href="#home">◉ &nbsp;О проекте</a><a href="#home">▥ &nbsp;Статистика</a><a href="#home">⚙ &nbsp;Поддержка</a></nav><div class="top-actions"><a class="btn" href="${esc(s.game_url||"#")}">🎮 &nbsp;Начать играть</a><a class="social" href="${esc(s.discord_url||"#")}">◉</a><a class="social" href="${esc(s.telegram_url||"#")}">➤</a></div></div></header>
 <main class="page"><div class="container"><section class="card hero glow"><div class="city"></div><div class="hero-content"><div class="eyebrow">Good Mobile Project</div><h1>GOOD <span>MOBILE</span></h1><div class="tag">${esc(s.tagline||"ТВОЙ НОВЫЙ ИГРОВОЙ МИР")}</div><p>${esc(s.hero_text||"Присоединяйся к нашему проекту и окунись в мир уникальных возможностей!")}</p><div class="actions"><a class="btn" href="${esc(s.game_url||"#")}">🎮 &nbsp;Начать играть</a><a class="btn ghost" href="#login">Панель управления</a></div><div class="hero-stats"><div class="mini-stat"><span class="muted tiny">Онлайн игроков</span><br><b>${Number(s.online_players||0).toLocaleString("ru-RU")}</b></div><div class="mini-stat"><span class="muted tiny">Серверов</span><br><b>${d.servers.length}</b></div></div></div><div class="hero-car">🏎</div></section>
 ...
 <section class="card pad" style="margin-top:14px"><div class="section-title"><h2>◉ Информация</h2></div><div class="project-info"><div class="logo-box">♛<br><small>GOOD</small></div><div class="info-list"><div><span>Название</span><b>${esc(s.project_name)}</b></div><div><span>Жанр</span><b>Role Play</b></div><div><span>Платформа</span><b>Android / iOS</b></div><div><span>Статус</span><b class="green">Онлайн</b></div></div></div></section></aside></div></div></main><footer class="footer"><div class="container footer-inner"><b>♛ GOOD MOBILE</b><span>© 2024. Все права защищены.</span><span>◉ &nbsp;➤ &nbsp;▶ &nbsp;♪</span></div></footer>`;
...
function login(){
 $("#app").innerHTML=`<main class="login-screen"><form id="login-form" class="card login-box"><div class="login-logo"><div class="brand-mark">♛</div><div class="brand-title">GOOD MOBILE</div><div class="brand-sub">PANEL MANAGEMENT</div></div><h2>Вход в панель</h2><p class="muted">Авторизуйтесь для управления проектом</p><label class="field"><span>Игровой логин</span><input class="input" name="login" value="admin" required></label><label class="field"><span>Пароль</span><input class="input" type="password" name="password" value="admin12345" required></label><button class="btn" style="width:100%;margin-top:7px">Войти в панель</button><div class="muted tiny" style="margin-top:14px;text-align:center">Демо: admin / admin12345</div><div style="text-align:center;margin-top:16px"><a class="purple tiny" href="#home">← Вернуться на сайт</a></div></form></main>`;
...
async function panel(page){
 ...
 $("#app").innerHTML=`<header class="topbar"><div class="container" style="display:flex;width:100%;align-items:center"><div class="brand"><span class="brand-mark">♛</span><div><div class="brand-title">GOOD MOBILE</div><div class="brand-sub">PANEL MANAGEMENT</div></div></div><div class="top-actions"><span class="badge">♛ ${esc(S.user?.name||"Admin")}</span><a class="social" href="#notifications">♧</a><button class="social" id="logout">⇥</button></div></div></header>
...
function nav(){return Object.entries(icons).filter(([k])=>k!=="login").map(([k,v])=>[k,v,{dashboard:"Главная",admins:"Администраторы",positions:"Должности",servers:"Серверы",links:"Ссылки",news:"Новости",applications:"Заявления",complaints:"Жалобы",settings:"Настройки",statistics:"Статистика",audit:"Аудит"}[k]])}
